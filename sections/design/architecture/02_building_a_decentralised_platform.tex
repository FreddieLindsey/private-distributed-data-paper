...
The above layers shown in \ref{fig:archi_platform_layers} are discussed below in order of design importance, i.e. the permissions layers is at the centre of the application and somewhat defines the design of the other two layers.
