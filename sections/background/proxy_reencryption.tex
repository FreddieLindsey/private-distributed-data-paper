...
In the above figure, it is demonstrated where the data is held or being manipulated by a fully trusted entity or not, using green/blue and red lines respectively.
