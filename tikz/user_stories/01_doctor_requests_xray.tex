\begin{figure}[H]
  ...
  \node[align = center] at (16, 16.5) { ID Valid };
  \draw [ -> ] (20, 16) -- (12, 16);
  ...
  \node[align = center] at (20, 10.5) { Logged };
  \draw [ -> ] (24, 10) -- (16, 10);

  \node[align = center] at (14, 9.5) { Logged };
  \draw [ -> ] (16, 9) -- (12, 9);

  \node[align = center] at (10, 8.5) { Logged };
  \draw [ -> ] (12, 8) -- (8, 8);

  \node[align = center] at (6, 7.5) { Logged };
  \draw [ -> ] (8, 7) -- (4, 7);
