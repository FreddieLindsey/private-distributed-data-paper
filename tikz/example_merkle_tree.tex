\begin{figure}[H]
  ...
  \node at (0, -9) { $\text{Node}_7$: \{ $\text{Key}_7$, $\text{Value}_7$ \} };
  ...
  \node at (-10, -11) { $\text{Node}_2$: \{ $\text{Key}_2$, $\text{Value}_2$ \} };
  \node at (0, -11) { $\text{Node}_3$: \{ $\text{Key}_3$, $\text{Value}_3$ \} };
  \node at (10, -11) { $\text{Node}_6$: \{ $\text{Key}_6$, $\text{Value}_6$ \} };
  ...
  \node at (-15, -13) { $\text{Node}_0$: \{ $\text{Key}_0$, $\text{Value}_0$ \} };
  \node at (-5, -13) { $\text{Node}_1$: \{ $\text{Key}_1$, $\text{Value}_1$ \} };

  \node at (5, -13) { $\text{Node}_4$: \{ $\text{Key}_4$, $\text{Value}_4$ \} };
  \node at (15, -13) { $\text{Node}_5$: \{ $\text{Key}_5$, $\text{Value}_5$ \} };
